...
//生产服务器
var SERVER_URL = 'https://cater.haidilao.com';
var SERVER_URL_HTTP = 'http://cater.haidilao.com';
var GU_QING_SERVER = 'http://appstock.haidilao.com:8080';
//测试服务器
// var SERVER_URL = 'http://hdl-tydc-manager.hdltest.com';
// var SERVER_URL_HTTP = 'http://hdl-tydc-manager.hdltest.com';
// var GU_QING_SERVER = 'http://172.18.36.20:7777';
// var SERVER_URL = 'http://hdl-tydc-manager.hdltest.com';
// var SERVER_URL = 'http://uat-cater.hdltest.com';
// var SERVER_URL = 'http://172.25.11.189:8087';
//自动买单卡包url
...
var NEW_QUERY_URL = 'http://qcenter.haidilao.com:7070';
...
//估清首次进入请求接口
var HAS_BEEN_SOLD_OUT_URL = GU_QING_SERVER + '/api/web/dishDynamic/list_test/';
//遗失物品配置
...
//请求已过期积分数据
var QUERY_EXPIRY_ACTION = WEBROOT_SNS + 'excInterface/queryMemberExpiryTxnInfo.action';
//请求已过期积分明细数据
var QUERY_EXPIRY_DETAIL_ACTION = WEBROOT_SNS + 'excInterface/queryMemberExpiryTxnDtlInfo.action';
//请求积分明细的即将过期积分数据
...
/*	var ADD_PRE_ORDER_DISHES_ACTION ='http://172.25.11.189:8087/Cater/terminus/addPreOrderDishes.action'*/
//预点餐订单查询
var GET_PRE_ORDER_ACTION = SERVER_URL + '/Cater/terminus/qureyPreOrderDishes.action'
...
var QUEUE_CATEGORY_FIND_ACTION = webpath_cater + '/terminus/dish/category/find.action'
//四宫格价格计算
var DISH_FOURPOT_PRICE_ACTION = SERVER_URL_HTTP + "/cater-order/hht/calc/gdprice"
//菜品口味定制
var DISH_LOADDISHTASTE_ACTION =
	webpath_cater + 'terminus/dish/personal/config/find.action'
//var DISH_LOADDISHTASTE_ACTION ='http://172.25.11.189:8087/Cater/terminus/dish/personal/config/find.action'
...
// 抽奖邮寄奖品确定接口
var EDIT_GIFTRECORD_ADDRESS = SERVER_URL + '/Cater/lottery/editGiftRecordAddress.action'
/** HI底盘*/
...
function statechange() {
	...
	if (hheader.length > 0 && hheader) {
		...
		if (isWeiXin()) {
			// document.getElementsByClassName('mui-icon-left-nav')[0].style ? document.getElementsByClassName('mui-icon-left-nav')[0].style.display =
			// 	'none':''
			// if (hshare) {
			// 	hshare.style?hshare.style.display = 'none':''
			// }
		}
	}
...
var networkRequestTypeGet = function(url, data, contentType, isAsync, successCallback, failCallback, requestDataType) {
	if (url === "" || url === null) {
		mui.alert("请求地址为空");
	}
